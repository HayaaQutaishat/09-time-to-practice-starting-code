...
When the user done "Add Quote" button, I've added a loading spinner to the application to provide visual feedback to the user while the request is being sent to the backend.
